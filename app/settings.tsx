...
class SettingsErrorBoundary extends React.Component<
  ...
  { hasError: boolean }
> {
  constructor(props: { children: React.ReactNode; theme: any }) {
    super(props);
      ...
      return (
        <View style={{ 
          ...
          <Text style={{ 
            ...
            Something went wrong loading the settings screen.
          </Text>
          <TouchableOpacity 
            style={{
          ...
          >
            <Text style={{ color: theme.colors.background, fontSize: theme.fontSize.md }}>
              Go to Home
            </Text>
          </TouchableOpacity>
        </View>
...
export default function SettingsScreen() {
  try {
    ...
    return (
      <SettingsErrorBoundary theme={theme}>
        <SettingsScreenContent />
      </SettingsErrorBoundary>
    );
  } catch (error) {
    console.error('Settings screen initialization error:', error);
    return (
      <View style={{ 
        flex: 1, 
        ...
        <Text style={{ 
          ...
          Unable to load settings. Please restart the app.
        </Text>
        <TouchableOpacity 
          style={{
