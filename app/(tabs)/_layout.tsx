    ...
    <Tabs
      screenOptions={{
        ...
        tabBarStyle: {
          ...
          height: getTabBarHeight(insets.bottom) + (Platform.OS === 'ios' ? 20 : 16),
          position: 'absolute',
          bottom: 0,
          left: 0,
          right: 0,
        ...
        tabBarLabelStyle: {
          ...
          marginTop: Platform.OS === 'ios' ? (isTablet ? 4 : 2) : (isTablet ? 2 : 1),
          marginBottom: Platform.OS === 'ios' ? (isTablet ? 4 : 2) : (isTablet ? 2 : 1),
        },
        tabBarIconStyle: {
          marginTop: Platform.OS === 'ios' ? (isTablet ? 4 : 2) : (isTablet ? 2 : 1),
          marginBottom: Platform.OS === 'ios' ? (isTablet ? 2 : 1) : (isTablet ? 1 : 0),
        },
        headerStyle: {
          backgroundColor: theme.colors.surface,
        ...
        tabBarItemStyle: {
          paddingVertical: Platform.OS === 'ios' ? (isTablet ? 4 : 2) : (isTablet ? 2 : 1),
