...
const isDesktop = Platform.OS === 'web' && (isElectron || screenWidth >= 1024);
const isWebBrowser = Platform.OS === 'web' && !isElectron;
...
// Get responsive value based on screen size and platform
const getResponsiveValue = <T>(values: {
  ...
  // Prioritize desktop sizing for Electron apps regardless of screen size
...
export const createTheme = (mode: ThemeMode = 'dark') => ({
  ...
  fontSize: {
    xs: getResponsiveValue({ phone: Platform.OS === 'ios' ? 12 : 11, tablet: Platform.OS === 'ios' ? 14 : 13 }),
    sm: getResponsiveValue({ phone: Platform.OS === 'ios' ? 14 : 13, tablet: Platform.OS === 'ios' ? 16 : 15 }),
    md: getResponsiveValue({ phone: Platform.OS === 'ios' ? 16 : 15, tablet: Platform.OS === 'ios' ? 18 : 17 }),
    lg: getResponsiveValue({ phone: Platform.OS === 'ios' ? 18 : 17, tablet: Platform.OS === 'ios' ? 20 : 19 }),
    xl: getResponsiveValue({ phone: Platform.OS === 'ios' ? 24 : 22, tablet: Platform.OS === 'ios' ? 28 : 26 }),
    xxl: getResponsiveValue({ phone: Platform.OS === 'ios' ? 32 : 28, tablet: Platform.OS === 'ios' ? 36 : 32 }),
    xxxl: getResponsiveValue({ phone: Platform.OS === 'ios' ? 40 : 36, tablet: Platform.OS === 'ios' ? 44 : 40 }),
  },
  fontWeight: {
    normal: '400' as const,
    medium: '500' as const,
  ...
  responsive: {
    minTouchTarget: getResponsiveValue({
      ...
      desktop: 36, // Smaller for desktop since no touch needed
    }),
    tabBarHeight: {
    ...
    cardMinHeight: getResponsiveValue({
      ...
      desktop: 48, // Smaller for desktop
    }),
    buttonMinHeight: getResponsiveValue({
      phone: Platform.OS === 'android' ? 48 : 44,
      tablet: Platform.OS === 'android' ? 52 : 48,
      largeTablet: Platform.OS === 'android' ? 56 : 52,
      desktop: 36, // Smaller for desktop
    }),
    ...
    fabSize: getResponsiveValue({ phone: 56, tablet: 64, largeTablet: 72, desktop: 52 }),
    iconButtonSize: getResponsiveValue({
      phone: Platform.OS === 'android' ? 48 : 44,
      tablet: Platform.OS === 'android' ? 52 : 48,
      largeTablet: Platform.OS === 'android' ? 56 : 52,
      desktop: 32, // Smaller for desktop
    }),
    // Device info
    isTablet,
    isLargeTablet,
    ...
    adaptiveSpacing: {
      xs: getResponsiveValue({ phone: isSmallScreen ? 2 : 4, tablet: 6, largeTablet: 8, desktop: 4 }),
      sm: getResponsiveValue({ phone: isSmallScreen ? 6 : 8, tablet: 12, largeTablet: 16, desktop: 8 }),
      md: getResponsiveValue({ phone: isSmallScreen ? 12 : 16, tablet: 20, largeTablet: 24, desktop: 12 }),
      lg: getResponsiveValue({ phone: isSmallScreen ? 18 : 24, tablet: 32, largeTablet: 40, desktop: 20 }),
      xl: getResponsiveValue({ phone: isSmallScreen ? 24 : 32, tablet: 40, largeTablet: 48, desktop: 24 }),
      xxl: getResponsiveValue({ phone: isSmallScreen ? 36 : 48, tablet: 64, largeTablet: 80, desktop: 32 }),
    },
