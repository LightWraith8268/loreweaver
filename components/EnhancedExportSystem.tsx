...
export const EnhancedExportSystem: React.FC<EnhancedExportSystemProps> = ({
  ...
  const styles = React.useMemo(() => {
    const currentTheme = createTheme(settings.theme);
    ...
    modalTitle: {
      ...
      fontWeight: currentTheme.fontWeight.bold as any,
    ...
    sectionTitle: {
      ...
      fontWeight: currentTheme.fontWeight.semibold as any,
      color: currentTheme.colors.text,
    ...
    formatName: {
      fontSize: currentTheme.fontSize.md,
      fontWeight: currentTheme.fontWeight.medium as any,
      color: currentTheme.colors.text,
      marginBottom: currentTheme.spacing.xs,
    },
    formatNameSelected: {
